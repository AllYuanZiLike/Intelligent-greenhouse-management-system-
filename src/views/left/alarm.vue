  ...
  >
    <div class="box">
      ...
      <div class="btn-box">
        ...
        <el-button @click="dialogVisible=true">添加温室</el-button>
      </div>
      <div class="table-box">
        <el-table :data="tableData.dataList" height="75%" style="width: 100%" @row-click="toggleGreenhouse">
          <el-table-column prop="name" label="温室名字" width="100" align="center" />
          <el-table-column prop="location" label="温室位置" width="120"  align="center"/>
